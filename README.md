...
4. If you are completing this test as part of a job application please include a zip file of your project with your application otherwise create a pull request and we'll take a look :)
